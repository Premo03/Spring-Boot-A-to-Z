...
import com.premjeet.cruddemo.entity.Review;
import com.premjeet.cruddemo.entity.Student;
...
public class Application {
	...
	public CommandLineRunner commandLineRunner(AppDAO appDAO) {
		...
		return runner -> {
			...
			// findStudentAndCources(appDAO);
			
			addMoreCourcesForStudents(appDAO);
		};
	}

	private void addMoreCourcesForStudents(AppDAO appDAO) {
	...
	private void findStudentAndCources(AppDAO appDAO) {
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		System.out.println("ave the course: " + tempCourse);
